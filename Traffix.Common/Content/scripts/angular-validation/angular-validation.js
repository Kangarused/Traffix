...
(function () {
    ...
    function Provider() {
        ...
        this.checkValid = function (form) {
            return !!(form && (form.$valid || form.$error == null || $.isEmptyObject(form.$error))); //todo: this is hack I inserted in here, for some reason there is no errors but form.$valid is undefined...
        };
